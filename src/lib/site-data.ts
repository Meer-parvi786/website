...
// Payment Methods Configuration - Edit account details here
export const paymentMethods = [
  {
    id: "bank-transfer",
    name: "Bank Transfer",
    nameUr: "Bank Transfer (IBFT)",
    icon: "landmark",
    color: "from-blue-500 to-blue-700",
    bgColor: "bg-blue-50",
    borderColor: "border-blue-200",
    textColor: "text-blue-700",
    description: "Direct bank transfer from any Pakistani bank account. Instant & free.",
    details: {
      bankName: "HBL (Habib Bank Limited)",
      accountTitle: "SkardoNest Tourism",
      accountNumber: "1234-5678-9012-3456",
      iban: "PK36HABB0012345678901234",
      branchCode: "0247",
      branch: "Skardu Main Branch",
    },
    instructions: [
      "Open your mobile banking app (HBL, MCB, UBL, etc.)",
      "Select 'Inter Bank Transfer' (IBFT)",
      "Enter the account details shown above",
      "Send the exact booking amount",
      "Screenshot the payment receipt",
  ...
  },
  {
    ...
    nameUr: "Debit / Credit Card",
    icon: "credit-card",
    color: "from-purple-500 to-purple-700",
    bgColor: "bg-purple-50",
    borderColor: "border-purple-200",
    textColor: "text-purple-700",
    description: "Pay securely with Visa, Mastercard, or JazzCash Debit Card.",
    details: {
      supportedCards: "Visa, Mastercard, JazzCash Debit Card",
      gateway: "Secure SSL Encrypted Payment",
      note: "Card payments are processed securely via encrypted gateway.",
    },
    instructions: [
      "Select 'Card Payment' option",
      "Enter your 16-digit card number",
      "Enter expiry date (MM/YY) and CVV",
      "Complete the 3D Secure verification (OTP)",
      "You will receive a confirmation SMS",
      "Share the transaction ID on WhatsApp",
    ],
    processingTime: "Instant",
  ...
  },
  {
    id: "easypaisa",
    name: "Easypaisa",
    nameUr: "Easypaisa (Telenor Microfinance Bank)",
    icon: "wallet",
    color: "from-green-500 to-emerald-700",
    bgColor: "bg-green-50",
    borderColor: "border-green-200",
    textColor: "text-green-700",
    description: "Pay from your Easypaisa mobile wallet. Easy & instant.",
    details: {
      accountTitle: "SkardoNest Tourism",
      accountNumber: "0347-8875789",
      telenorAccount: "0347-8875789",
      network: "Easypaisa App / Any Easypaisa Agent",
    },
    instructions: [
      "Open Easypaisa App on your phone",
      "Go to 'Send Money' or 'Bank Transfer'",
      "Enter our Easypaisa number: 0347-8875789",
      "Enter the exact booking amount",
      "Confirm the transaction with your PIN",
      "Share the TID (Transaction ID) on WhatsApp",
    ],
    processingTime: "Instant",
    fee: "Free (No charges)",
  },
  {
    id: "jazzcash",
    name: "JazzCash",
    nameUr: "JazzCash (Mobilink Microfinance Bank)",
    icon: "smartphone",
    color: "from-red-500 to-rose-700",
    bgColor: "bg-red-50",
    borderColor: "border-red-200",
    textColor: "text-red-700",
    description: "Pay from your JazzCash mobile wallet. Fast & convenient.",
    details: {
      accountTitle: "SkardoNest Tourism",
      accountNumber: "0347-8875789",
      jazzCashNumber: "0347-8875789",
      network: "JazzCash App / Any JazzCash Agent",
    },
    instructions: [
      "Open JazzCash App on your phone",
      "Go to 'Send Money' option",
      "Enter our JazzCash number: 0347-8875789",
      "Enter the exact booking amount",
